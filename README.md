...
```javascript
import duration2ms from 'https://cdn.jsdelivr.net/gh/stdlib-js/time-duration2ms@v0.2.1-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/time-duration2ms/actions/workflows/test.yml/badge.svg?branch=v0.2.1
[test-url]: https://github.com/stdlib-js/time-duration2ms/actions/workflows/test.yml?query=branch:v0.2.1
